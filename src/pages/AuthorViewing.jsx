        ...
        <div className="container mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[2fr_1fr] gap-6 lg:gap-8">
            ...
            <div className="w-full xl:max-w-[400px]">
              <div className="bg-white rounded-xl my-5 grid grid-cols-1 gap-5 py-5 w-full">
                <h3 className="px-4 text-lg font-semibold">Bibian Okoro</h3>
                <hr className="text-gray-300" />

                <div className="space-y-6">
                  {blogposts.map((blogpost) => {
                    return (
                      <div key={blogpost.id} className="w-full px-4">
                        <div className="w-full">
                          <img
                        ...
                        <div className="rounded-b-lg flex flex-col gap-4 p-4 sm:p-6 bg-white shadow-lg">
                          ...
                          <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0 sm:items-center">
                            <p className="bg-[rgba(188,178,218,0.3)] py-1 px-3 sm:px-5 rounded-full cursor-pointer text-sm w-fit">
                              {blogpost.tags}
                            </p>
                ...
                <p className="text-center text-[rgba(142,142,142,1)] underline text-sm hover:text-blue-600 cursor-pointer px-4">
