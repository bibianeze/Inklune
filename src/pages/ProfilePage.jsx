          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
            ...
            <div className="flex-1 w-full">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <h3 className="text-2xl font-bold">Bibian Okoro</h3>
                <button
              ...
              <div className="bg-white shadow rounded p-4 mt-4">
                ...
                <p className="text-gray-700 text-sm">
                  As a proud Capricorn, I have a deep appreciation for nature,
                  especially my vibrant flowers. I also enjoy indulging in
                  luxurious hair care that reflects my personality.
                </p>
              </div>
            </div>
          </div>
